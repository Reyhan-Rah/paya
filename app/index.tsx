...
const App: React.FC = () => {
  ...
  const handleSubmit = () => {
    console.log(
      'Submit form with selected values, route to the next step or display the result',
    );
  };
          ...
          >
            <View>
              ...
              <View style={styles.header}>
                ...
                <TouchableOpacity
                  onPress={() => {
                    console.log('should route back to the previous screen');
                  }}
                >
                  <Image
                    source={BackIcon}
              ...
              />
              <CustomTextInput
                placeholder="ارائه کننده آگهی"
                value={agahi}
                onChangeText={setAgahi}
              />
              <CustomTextInput
